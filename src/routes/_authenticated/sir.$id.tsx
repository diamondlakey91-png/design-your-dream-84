...
function SirBriefDetailPage() {
  ...
  return (
    <AppShell>
      <PermivioPageHeader title="Site Investigation" subtitle={data?.brief?.site_address || data?.brief?.jurisdiction || "Brief progress"} />

      <Link to="/sir" className="mt-4 inline-flex items-center gap-1 text-xs text-slate-400 hover:text-white">
